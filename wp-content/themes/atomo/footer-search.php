  ...
  <?php /* TODO: Who is `Euroamérica <scliente@euroamerica.cl>` really? */ ?>

  <footer id="site-footer" class="footer">
    <div class="row">
      <div class="col-md-6">
        <p><?php _e( 'Contact', 'atomo' ); ?><!-- Contacto --></p>
        <a class="mail-link" href="mailto:scliente@euroamerica.cl">
		  mailto:scliente@euroamerica.cl
	    </a>
        <p class="copyright">© <?php echo date('Y'); ?> Euroamérica</p>
      </div>
      <div class="col-md-6 flex justify-end align-center">
        <p><?php _e( 'Follow Us', 'atomo' ); ?><!-- Siguenos --></p>
        <div class="social-container flex align-center">
          <a id="facebook-link" class="flex social-link" href="">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewbox="0 0 32 32">
              <path d="M19 6h5v-6h-5c-3.86 0-7 3.14-7 7v3h-4v6h4v16h6v-16h5l1-6h-6v-3c0-0.542 0.458-1 1-1z"></path>
            </svg>
		  </a><!-- #facebook-link -->
          <a id="twitter-link" class="flex social-link twitter" href="" target="_blank">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewbox="0 0 32 32">
