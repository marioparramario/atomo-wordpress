        ...
        <footer>
            <div class="row">
                <div class="col-sm-6">
                    <p><?php _e( 'Contacto', 'euroamerica-v3' ); ?></p>
                    <a class="mail-link" href="mailto:scliente@euroamerica.cl"><?php _e( 'scliente@euroamerica.cl', 'euroamerica-v3' ); ?></a>
                    <div class="social-container flex align-center">
                        ...
                        <a href="https://twitter.com/MundoFinanciero" target="_blank" class="flex twitter">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewbox="0 0 32 32">
                ...
                <div class="flex-vertical align-end col-sm-6 col-footer-logo">
                    <img class="logo-euro" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/logo-euro.png" />
                    <p class="copyright"><?php _e( 'EuroAmerica ©', 'euroamerica-v3' ); ?><?php echo date('Y') ?></p>
                </div>
            </div>
        </footer>
