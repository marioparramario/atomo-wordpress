        ...
        <footer>
            <div class="row">
                <div class="col-md-6">
                    <p><?php _e( 'Contacto', 'buen_consejo' ); ?></p>
                    <a class="mail-link" href="mailto:scliente@euroamerica.cl"><?php _e( 'scliente@euroamerica.cl', 'buen_consejo' ); ?></a>
                    <p class="copyright"><?php _e( 'Euroamérica ©', 'buen_consejo' ); ?><?php echo date('Y') ?></p>
                </div>
                <div class="col-md-6 flex justify-end align-center">
                    <p><?php _e( 'Síguenos', 'buen_consejo' ); ?></p>
